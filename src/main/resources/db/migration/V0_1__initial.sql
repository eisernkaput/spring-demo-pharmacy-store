...
alter table warehouse_stock add constraint fk_warehouse_address_id foreign key (warehouse_address_id) references warehouse_address(id);
create index warehouse_address_id_idx on warehouse_address (warehouse_id);